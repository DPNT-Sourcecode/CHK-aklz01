'use strict';
const { OffersEngine, makeGetOneFreeHandler, makeGroupOfferHandler, makeMultiBuyHandler } = require('./offers_engine');
const { GET_ONE_FREE_OFFERS, GROUP_OFFERS, MULTI_BUY_OFFERS, PRICES } = require('./chk_config');
...
class CheckoutSolution {
    constructor() {
        ...
        const offerHandlers = [
            ...
            makeGroupOfferHandler(GROUP_OFFERS),
        ];
